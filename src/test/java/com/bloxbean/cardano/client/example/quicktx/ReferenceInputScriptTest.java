...
/**
 * Example to show how to use reference input in a script tx
 */
public class ReferenceInputScriptTest extends QuickTxBaseTest {
    @Test
    void referenceInputUtxo_guessSumScript() throws ApiException, InterruptedException {
        ...
        /**** Create reference input and Lock funds to script address ****/
        //Create a reference input and send lock amount at script address
        Tx createRefInputTx = new Tx();
        createRefInputTx.payToAddress(receiver1Addr, List.of(Amount.ada(1.0)), sumScript)
                .from(sender1Addr);
        ...
        /***** End of reference input creation and lock funds to script address ****/
        ...
        ScriptTx scriptTx = new ScriptTx()
                ...
                .readFrom(refUtxo)
                .payToAddress(receiver1Addr, List.of(sumScriptAmt))
