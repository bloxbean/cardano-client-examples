...
public class AlwaysSuccessContractCall extends BaseTest {
    ...
    PlutusV1Script contractScript = PlutusV1Script.builder()
            .type("PlutusScriptV1")
    ...
    @Test
    public void run() throws CborException, AddressExcepion, CborDeserializationException, CborSerializationException, ApiException {
    ...
    public void transferFundAndCallContract() throws CborSerializationException, AddressExcepion, ApiException, CborDeserializationException, CborException {
        ...
        transactionWitnessSet.setPlutusV1Scripts(Arrays.asList(contractScript));
